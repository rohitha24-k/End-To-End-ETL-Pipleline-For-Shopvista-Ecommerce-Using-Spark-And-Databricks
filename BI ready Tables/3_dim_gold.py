...
# MAGIC %md
# MAGIC #### To product table we are adding category name and brand name so that it will be useful when we are preparing BI reports 
# MAGIC (Here first we join brand and category tables so that brand code and category code comes together and later we join the obtained table to products )
# MAGIC
...
# MAGIC %md
# MAGIC #### We add region to customer table
# MAGIC (when the stakeholders or anyone who want the info about the customer insights region wise using this column we can find easily. we define region based on the cardinal directions. we make a dictionary for each country)
...
# MAGIC %md
# MAGIC #### Joining region dataframe to customer 
...
# MAGIC %md
# MAGIC #### Adding month and is weekend to th table
# MAGIC
